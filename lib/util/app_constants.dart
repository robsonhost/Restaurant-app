...
class AppConstants {
  static const String appName = 'Mont Envios';
  static const double appVersion = 7.5;

  static const String baseUrl = 'https://painel.montenvios.com.br';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.brasil, languageName: 'Brasil', countryCode: 'BR', languageCode: 'br'),
